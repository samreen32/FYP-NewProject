        ...
        >
          ...
          <View style={styles.section}>
            <View
              style={
                selectedApp == 1
                  ? [{ color: "white" }, styles.sectionHeader]
                  : [{ color: "black" }, styles.sectionHeader]
              }
            >
          ...
          <View style={styles.section}>
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("FAQScreen_Warden");
                }}
              >
                <Text style={styles.sectionItem}>
                  {" "}
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("AboutScreen_Warden");
                }}
              >
                <Text style={styles.sectionItem}>
                  {" "}
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("ContactScreen_Warden");
                }}
              >
                <Text style={styles.sectionItem}>
                  {" "}
